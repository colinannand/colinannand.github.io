...
knitr::include_graphics("../images/fema_logo_circle.png")
```
...
load(file = "../extdata/tribe2023_tagged.Rdata", verbose=FALSE) #updated 2023 data, adds 3 DRs.
```
...
```{r echo = FALSE, include = FALSE}
#load PDA Data
load(file="../extdata/FIDA-wFIPS.Rdata", verbose=F)
...
load(file="../extdata/FACT_PDA.Rdata")
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
load(file="../extdata/dr_agg_from_counties.Rdata")
